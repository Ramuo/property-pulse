...
const ProfilePage = () => {
    ...
    useEffect(() => {
        ...
        //Fetch user properties when session is avalable
        if(session?.user?.id){
                ...
                <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                    ...
                    <div className="flex flex-col md:flex-row">
                        <div className="md:w-1/4 mx-20 mt-10">
                            ...
                            <h2 className="text-2xl mb-4"><span className="font-bold block">Nom: </span> {profileName}</h2>
                        ...
                        <div className="md:w-3/4 md:pl-4">
                            ...
                            {!loading && properties.length === 0 && (
                                <p>Vous n'avez pas de propriété publiée</p>
                            )}
